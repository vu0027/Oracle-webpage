...
<body>
	...
	String price = request.getParameter("price");
		...
		ResultSet customer =  handler.findQuery8(Integer.parseInt(price));
	...
	<table cellspacing="2" cellpadding="2" border="1">
		...
		<%
			...
			out.println("<tr>");
			out.println("<td align=\"center\">" + cname + "<td align=\"center\">" + String.valueOf(pr));
			out.println("</tr>");
		}
		%>
	</table>
